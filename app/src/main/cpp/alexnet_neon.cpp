...
JNICALL
Java_com_chenleiblogs_mlopencl_ml_1opencl_MainActivity_alexnetWithNeon(
        JNIEnv *env,
        jobject /* this */) {

   //模拟了AlexNet部分 使用ARM的NEON指令集加速 陈雷@西安电子科技大学
    Tensor input;
    ...
    ss>>s;
    //记录耗时多少
    std::string hello = "Alexnet cost "+ s + " ms (using neon)";
