...
JNICALL
Java_com_chenleiblogs_mlopencl_ml_1opencl_MainActivity_alexnetWithOpenCL(
        JNIEnv *env,
        jobject /* this */) {

    //模拟了AlexNet部分 使用ARM的Mali GPU的OpenCL加速 陈雷@西安电子科技大学
    ICLTensor input;
    ...
    CLConvolutionLayer conv_1;
    CLConvolutionLayer conv_2;
    CLConvolutionLayer conv_3;
    CLConvolutionLayer conv_4;
    CLConvolutionLayer conv_5;
    CLActivationLayer Nact_1;
    CLActivationLayer Nact_2;
    CLActivationLayer Nact_3;
    CLActivationLayer Nact_4;
    CLActivationLayer Nact_5;
    CLPoolingLayer Npool_1;
    CLPoolingLayer Npool_2;
    CLPoolingLayer Npool_5;
    CLNormalizationLayer LRN_1;
    CLNormalizationLayer LRN_2;
    CLFullyConnectedLayer fc_8;
    ...
    //in: 55 * 55 * 96, out: 27 * 27 * 96
    LRN_1.configure(&pool_1, &lrn_1, NormalizationLayerInfo(NormType::IN_MAP_2D));
    ...
    LRN_2.configure(&pool_2, &lrn_2, NormalizationLayerInfo(NormType::IN_MAP_2D));
    ...
    //记录耗时多少
    std::string hello = "Alexnet cost "+ s + " ms (using opencl)";
